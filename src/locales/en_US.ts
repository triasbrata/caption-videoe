...
const enUS: FlyCutCaptionLocale = {
  ...
  components: {
    ...
    asrPanel: {
      ...
      asrCompleteDetail: 'Successfully recognized {count} sentence segments in {duration} seconds',
      ...
      modelLoadSuccessDetail: 'Speech recognition model is ready, you can start transcription',
      ...
      preparingModelDetail: 'First use requires downloading and loading the model...',
      ...
      audioExtractionFailed: 'Audio extraction failed, please check the file format',
      ...
      wasmDescription: 'WebAssembly: Better compatibility, works on all browsers',
      modelDownloadNote: 'First use will download approximately {size} of model files',
    ...
    exportDialog: {
      ...
      subtitleFormatDescription: 'Select subtitle format and export subtitle file',
      ...
      deletedNotIncluded: 'Deleted subtitle segments will not be included in the export file',
      ...
      softBurn: 'Soft Burn',
      softBurnDescription: 'Subtitle embedded as separate track, can be toggled',
      hardBurn: 'Hard Burn',
      hardBurnDescription: 'Subtitle burned directly into video',
      exportNotes: 'Notes',
      exportWarning: 'Video export may take a while. Please do not close the browser during the export process.',
