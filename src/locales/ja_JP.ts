...
const jaJP: FlyCutCaptionLocale = {
  ...enUS,
  common: {
    ...enUS.common,
    loading: "読み込み中...",
  ...
  components: {
    ...
    translationPanel: {
      ...enUS.components.translationPanel,
      title: "翻訳",
      startTranslation: "字幕を翻訳",
      ...
      translationCompleteDetail: "{count}個の文セグメントを翻訳しました",
      translationFailed: "翻訳失敗",
      unknownError: "不明なエラー",
      loadingModel: "翻訳モデル読み込み中",
      loadingModelDefault: "初回使用時はモデルファイルのダウンロードが必要です...",
      translating: "翻訳中",
      translatingDetail: "字幕を翻訳中、お待ちください...",
      translatingFrom: "{source}から{target}へ翻訳中",
      modelLoadSuccess: "モデル読み込み成功",
      modelLoadSuccessDetail: "翻訳モデルの準備ができました",
      modelLoadReady: "翻訳モデル準備完了",
      modelLoadFailed: "モデル読み込み失敗",
      noTranscript: "翻訳可能な字幕がありません",
      generateTranscriptFirst: "まず音声認識で字幕を生成してください",
      startTranslationMessage: "翻訳開始",
      preparingModel: "モデル準備中...",
      preparingModelDetail: "初回使用時はモデルのダウンロードと読み込みが必要です...",
      retryTranslation: "翻訳を再試行中...",
      retryTranslationMessage: "翻訳を再開",
      retryTranslationDetail: "字幕を再処理中...",
      languageSwitchSuccess: "言語切替成功",
      languageSwitchedTo: "ターゲット言語を{language}に設定しました",
      translationProcessFailed: "翻訳処理失敗",
      translationProgress: "翻訳進行状況",
      searchLanguagePlaceholder: "翻訳言語を検索...",
      statusFailed: "失敗",
      statusCompleted: "完了",
