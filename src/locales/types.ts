...
export interface FlyCutCaptionLocale {
  ...
  components: {
    ...
    translationPanel: {
      ...
      translationCompleteDetail: string;
      translationFailed: string;
      unknownError: string;
      loadingModel: string;
      loadingModelDefault: string;
      translating: string;
      translatingDetail: string;
      ...
      modelLoadFailed: string;
      noTranscript: string;
      generateTranscriptFirst: string;
      startTranslationMessage: string;
      preparingModel: string;
      preparingModelDetail: string;
      retryTranslation: string;
      retryTranslationMessage: string;
      retryTranslationDetail: string;
      languageSwitchSuccess: string;
      languageSwitchedTo: string;
      translationProcessFailed: string;
