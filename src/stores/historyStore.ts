...
// 独立的动作选择器，避免创建新对象引用
export const useSetTranscript = () =>
  useHistoryStore((state) => state.setTranscript);
...
export const useClearHistory = () =>
  useHistoryStore((state) => state.clearHistory);
export const useDeleteSelected = () =>
  useHistoryStore((state) => state.deleteSelected);
export const useRestoreSelected = () =>
  useHistoryStore((state) => state.restoreSelected);
export const useUpdateChunkText = () =>
  useHistoryStore((state) => state.updateChunkText);
...
export const useHistoryLanguage = () =>
  useHistoryStore((state) => state.language);
export const useHistoryDuration = () =>
  useHistoryStore((state) => state.duration);
